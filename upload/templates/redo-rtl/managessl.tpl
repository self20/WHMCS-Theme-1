...
<div class="table-container clearfix">
    <table id="tableSslList" class="table table-list datatable table table-hover table-bordered Redo-table table-primary">
        <thead>
            <tr>
                <th data-class="expand">Domain</th>
                <th data-hide="phone">SSL Product</th>
                <th data-hide="phone,tablet">Order Date</th>
                <th data-hide="phone,tablet">Renewal Date</th>
                <th>Actions</th>
            </tr>
        </thead>
        <tbody>
