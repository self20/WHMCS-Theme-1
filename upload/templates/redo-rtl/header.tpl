...
<html lang="en">
	...
	<body class="Redo header-2 menu-in-right {if $showingLoginPage}login{/if} rtl" data-phone-cc-input="{$phoneNumberInputStyle}">	
	{if !$showingLoginPage}
				...
				<div class="row">
					...
					<div class="col-xs-5 col-sm-6">
						...
						<ul class="list-unstyled list-inline visible-xs">
							<li>
								<span  class="tooltip-primary" data-placement="left" data-rel="tooltip" title="+ 91 124 2250121">
									<i class="fa fa-phone"></i>
								</span>
							</li>
							<li>
								<span  class="tooltip-primary" data-placement="left" data-rel="tooltip" title="info@example.com">
	...
	<div class="page-container"><!-- /page container -->
		...
		{if $templatefile eq 'homepage' or $pagetype eq 'redo' or $carttpl eq 'redo-default' or $carttpl eq 'redo-default-rtl'}{else}
		<div class="container-fluid">
			<div class="block-s3">
