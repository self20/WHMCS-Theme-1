...
*}
		...
		<div class="mass-head">
			<div class="hero-bg-wrap top bg-opacity" style="background-image: url({$WEB_ROOT}/templates/{$template}/assets/images/hero-bg2.jpg);">
					...
					<div class="Redo-image-box">
						<div class="row">
							...
							<div class="col-lg-7 col-md-6">
								...
								<img class="img-responsive" alt="Scripts" src="{$WEB_ROOT}/templates/{$template}/assets/images/scripts.png" />
							</div>
						</div>
					</div>
