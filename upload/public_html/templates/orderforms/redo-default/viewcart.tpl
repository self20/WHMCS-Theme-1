												...
												<div class="row">
													...
													<div class="col-sm-4 item-price">
														...
														{else}
															<span name="{$domain.domain}Price">{$domain.price}</span>
															<div class="dropdown">
																<button class="btn btn-default btn-xs btn-warning dropdown-toggle" type="button" id="{$domain.domain}Pricing" name="{$domain.domain}Pricing" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
								...
								<div class="order-summary" id="orderSummary">
									...
									<div class="summary-container">
										...
										<div class="text-right">
											{if $checkout}{else}<a href="cart.php?a=checkout" class="btn btn-success btn-lg btn-checkout{if $cartitems == 0} disabled{/if}" id="checkout">
