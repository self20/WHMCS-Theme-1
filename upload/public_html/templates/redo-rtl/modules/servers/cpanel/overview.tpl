				...
				<div class="col-md-6">
					...
					<div class="panel panel-default" id="cPanelPackagePanel">
						...
						<div class="panel-body text-center">
							...
							{if $dedicatedip}
								<h5 class="heading"><em>{$LANG.primaryIP}</em></h4>
								<p>{$dedicatedip}</p>
							{/if}
						...
						<div class="panel-body text-center cpanel-usage-stats">
							...
							<div class="row">
								<div class="col-sm-5 col-sm-offset-1 col-xs-6" id="diskUsage">
									...
									<br /><br />
									<input type="text" value="{$diskpercent|substr:0:-1}" class="usage-dial" data-fgColor="#444" data-angleOffset="-125" data-angleArc="250" data-min="0" data-max="100" data-readOnly="true" data-width="100" data-height="80" />
									<br /><br />
